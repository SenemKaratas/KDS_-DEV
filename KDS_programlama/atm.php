...
<div id="container">
	...
	<div id="elin">
		...
		<div id="menu">
			<ul>
				<li style="width:160px;background:white"><a href="atm.php" title="ATM" style="color:black">ATM Cihazları</a></li>
	...
	$sql = "SELECT ocak,subat,mart,nisan,mayis
	FROM atm_kullanim_orani";
...
<html>
	...
	<body>	   
	    <div class="container">	
	    <h1>ATM Cihazlarının Aylara Göre Kullanımı</h1>       
			...
			<script>
        		...
        		type: 'line',
		        data: {
		            labels: ['Adnan Kahveci ','Atadan','Buca Egitim Fak.','Buca Koop.','Buca Otoyol Çıkışı','Çamlıpark','DEU Adalet','DEU İİBF','Dedekorkut','DEU İşletme','DEU Tınaztepe','ESHOT Genel M.','Fevzi Çakmak','İnönü','Kozağaç','Menderes','Nato Karargahı'],
		            datasets: 
		            [{
		                label: 'ocak',
		                data: [<?php echo $data1; ?>],
...
$bilgi=mysqli_query($con,"SELECT atm.atm_no,atm.atm_ad,atm_kullanim_orani.ocak,atm_kullanim_orani.subat,atm_kullanim_orani.mart,atm_kullanim_orani.nisan,atm_kullanim_orani.mayis 
FROM atm,atm_kullanim_orani,kullanim_atm
WHERE atm.atm_no=kullanim_atm.kullanim_id AND
	atm_kullanim_orani.kullanim_id=kullanim_atm.kullanim_id");
echo '<table class="tablo" border="1" cellpadding="10" cellspacing="3">
	<tr>
		<td width="100" bgcolor="#E7E7E7"><b>Atm No</b></td>	
		<td width="100" bgcolor="#E7E7E7"><b>Atm</b></td>	
